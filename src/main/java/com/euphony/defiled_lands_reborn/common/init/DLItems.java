...
public class DLItems {
    ...
    public static final DeferredItem<Item> SCUTTLER_EYE = register("scuttler_eye",
            p -> new Item(p.food(DLFoods.SCUTTLER_EYE)));
    public static final DeferredItem<Item> BLACK_HEART = register("black_heart",
            p -> new Item(p.food(DLFoods.BLACK_HEART)));
    ...
    public static final DeferredItem<Item> FOUL_CANDY = register("foul_candy",
            p -> new Item(p.food(DLFoods.FOUL_CANDY)));
    public static final DeferredItem<Item> RAW_BOOK_WYRM = register("raw_book_wyrm",
            p -> new Item(p.food(DLFoods.RAW_BOOK_WYRM)));
    ...
    public static final DeferredItem<AxeItem> UMBRIUM_AXE = register("umbrium_axe",
            p -> new AxeItem(DLTiers.UMBRIUM, p.attributes(AxeItem.createAttributes(DLTiers.UMBRIUM, 6.0f, -3.1F))));
    public static final DeferredItem<HoeItem> UMBRIUM_HOE = register("umbrium_hoe",
            p -> new HoeItem(DLTiers.UMBRIUM, p.attributes(HoeItem.createAttributes(DLTiers.UMBRIUM, -2.0f, -1.0F))));
    public static final DeferredItem<PickaxeItem> UMBRIUM_PICKAXE = register("umbrium_pickaxe",
            p -> new PickaxeItem(DLTiers.UMBRIUM, p.attributes(PickaxeItem.createAttributes(DLTiers.UMBRIUM, 1.0f, -2.8F))));
    public static final DeferredItem<ShovelItem> UMBRIUM_SHOVEL = register("umbrium_shovel",
            p -> new ShovelItem(DLTiers.UMBRIUM, p.attributes(ShovelItem.createAttributes(DLTiers.UMBRIUM, 1.5f, -3.0F))));
    public static final DeferredItem<SwordItem> UMBRIUM_SWORD = register("umbrium_sword",
            p -> new SwordItem(DLTiers.UMBRIUM, p.attributes(SwordItem.createAttributes(DLTiers.UMBRIUM, 3.0f, -2.4F))));
    ...
    public static final DeferredItem<ArmorItem> UMBRIUM_HELMET = register("umbrium_helmet",
            p -> new ArmorItem(DLArmorMaterials.UMBRIUM, ArmorItem.Type.HELMET, p
                    .durability(ArmorItem.Type.HELMET.getDurability(18))));
    public static final DeferredItem<ArmorItem> UMBRIUM_CHESTPLATE = register("umbrium_chestplate",
            p -> new ArmorItem(DLArmorMaterials.UMBRIUM, ArmorItem.Type.CHESTPLATE, p
                    .durability(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE.getDurability(18))));
    public static final DeferredItem<ArmorItem> UMBRIUM_LEGGINGS = register("umbrium_leggings",
            p -> new ArmorItem(DLArmorMaterials.UMBRIUM, ArmorItem.Type.LEGGINGS, p
                    .durability(ArmorItem.Type.LEGGINGS.getDurability(18))));
    public static final DeferredItem<ArmorItem> UMBRIUM_BOOTS = register("umbrium_boots",
            p -> new ArmorItem(DLArmorMaterials.UMBRIUM, ArmorItem.Type.BOOTS, p
                    .durability(ArmorItem.Type.BOOTS.getDurability(18))));

    public static final DeferredItem<ArmorItem> BOOK_WYRM_SCALE_HELMET = register("book_wyrm_scale_helmet",
    ...
    public static final DeferredItem<ArmorItem> BOOK_WYRM_SCALE_CHESTPLATE = register("book_wyrm_scale_chestplate",
    ...
    public static final DeferredItem<ArmorItem> BOOK_WYRM_SCALE_LEGGINGS = register("book_wyrm_scale_leggings",
    ...
    public static final DeferredItem<ArmorItem> BOOK_WYRM_SCALE_BOOTS = register("book_wyrm_scale_boots",
            p -> new ArmorItem(DLArmorMaterials.BOOK_WYRM_SCALE, ArmorItem.Type.BOOTS, p
                    .durability(ArmorItem.Type.BOOTS.getDurability(10))));

    public static final DeferredItem<ArmorItem> GOLDEN_BOOK_WYRM_SCALE_HELMET = register("golden_book_wyrm_scale_helmet",
            p -> new ArmorItem(DLArmorMaterials.GOLDEN_BOOK_WYRM_SCALE, ArmorItem.Type.HELMET, p
                    .durability(ArmorItem.Type.HELMET.getDurability(10))));
    public static final DeferredItem<ArmorItem> GOLDEN_BOOK_WYRM_SCALE_CHESTPLATE = register("golden_book_wyrm_scale_chestplate",
            p -> new ArmorItem(DLArmorMaterials.GOLDEN_BOOK_WYRM_SCALE, ArmorItem.Type.CHESTPLATE, p
                    .durability(ArmorItem.Type.CHESTPLATE.getDurability(10))));
    public static final DeferredItem<ArmorItem> GOLDEN_BOOK_WYRM_SCALE_LEGGINGS = register("golden_book_wyrm_scale_leggings",
            p -> new ArmorItem(DLArmorMaterials.GOLDEN_BOOK_WYRM_SCALE, ArmorItem.Type.LEGGINGS, p
                    .durability(ArmorItem.Type.LEGGINGS.getDurability(10))));
    public static final DeferredItem<ArmorItem> GOLDEN_BOOK_WYRM_SCALE_BOOTS = register("golden_book_wyrm_scale_boots",
    ...
    public static final DeferredItem<AxeItem> RAVAGING_AXE = register("ravaging_axe",
            p -> new AxeItem(DLTiers.RAVAGING, p.stacksTo(1).attributes(AxeItem.createAttributes(DLTiers.RAVAGING, 5.0f, -3.0F)).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final DeferredItem<PickaxeItem> RAVAGING_PICKAXE = register("ravaging_pickaxe",
            p -> new PickaxeItem(DLTiers.RAVAGING, p.stacksTo(1).attributes(PickaxeItem.createAttributes(DLTiers.RAVAGING, 1.0f, -2.8F)).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final DeferredItem<ShovelItem> RAVAGING_SHOVEL = register("ravaging_shovel",
            p -> new ShovelItem(DLTiers.RAVAGING, p.stacksTo(1).attributes(ShovelItem.createAttributes(DLTiers.RAVAGING, 1.5f, -3.0F)).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)));
